const { getAllMyTodos, getTodoById, createTodo, deleteTodoItem, updateTodoItem} = require('./todo.controllers')
...
const updateById = (req, res) => {
    ...
    const data = req.body
    if(id){
       const item = updateTodoItem(id, data)
       if(item){
